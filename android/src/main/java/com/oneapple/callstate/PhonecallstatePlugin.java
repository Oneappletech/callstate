      ...
      try {
        switch (state) {
          case TelephonyManager.CALL_STATE_IDLE:
            channel.invokeMethod("phone.disconnected_"+incomingNumber, true);
            break;
          case TelephonyManager.CALL_STATE_RINGING:
            channel.invokeMethod("phone.incoming_"+incomingNumber, true);
            break;
          case TelephonyManager.CALL_STATE_OFFHOOK:
            channel.invokeMethod("phone.connected_"+incomingNumber, true);
            break;
